...
namespace ZXClient.util
{
    public class HttpUtil
    {
        ...
        public static void GetData(string POSTURL, DownloadStringCompletedEventHandler act)
        {
            Utils.HttpRequestHelper.AsyncGetWithWebClient(POSTURL, act);

            //Utils.RequestHttpWebRequest r = new Utils.RequestHttpWebRequest();
            //r.GetResponseAsync(new Utils.RequestInfo("http://www.baidu.com")
            //{
        ...
        public static StreamReader RequestStream(string POSTURL, string PostData)
        {
            try
            {
                LogHelper.WriteInfo(typeof(HttpUtil), POSTURL + "?" + PostData);
